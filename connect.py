...
class Connect:
    def __init__(self, error_cb=error_callback, web_arg_parser=None):
        ...
        arg_parser.add_argument(
            "--key",
            "-k",
            help="path to spotify_appkey.key (can be obtained from https://developer.spotify.com/my-account/keys )",
        ...
        print(
            "Using libspotify_embedded version: {}".format(
        ...
        self.credentials = dict(
            {"device-id": str(uuid.uuid4()), "username": None, "blob": None}
        )
        ...
        self.config = {
            ...
            "deviceId": ffi.new("char[]", self.credentials["device-id"].encode()),
